...
help:
	@echo "install"
	@echo "        Install wandb_preempt and dependencies"
	@echo "uninstall"
	@echo "        Uninstall wandb_preempt"
	@echo "lint"
	...
	@echo "conda-env"
	@echo "        Create conda environment 'wandb_preempt' with dev setup"
	@echo "darglint-check"
...
test:
	@pytest -vx --run-optional-tests=expensive --cov=wandb_preempt test

test-light:
	@pytest -vx --cov=wandb_preempt test
...
darglint-check:
	@darglint --verbosity 2 wandb_preempt test
